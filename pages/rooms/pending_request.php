						...
						<div class="user-status table-responsive latest-order-table">
							<table id="datatable" class="table table-bordernone">
								...
								<tr>
									...
									<td class="digits"><span class="label label-secondary" style="padding: 5px">pending</span></td>
									<td class="digits">
								...
								<tr>
									...
									<td class="digits">12:00 PM</td>
									<td class="digits">02:00 PM</td>
									<td class="digits"><span class="label label-primary" style="padding: 5px">timout</span></td>
									<td class="digits">
